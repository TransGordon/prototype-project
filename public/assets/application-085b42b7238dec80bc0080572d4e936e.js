...
(function() {
  ...
  searchModules = function(val) {
    $(".profile-checks").show();
    if (val !== '') {
      return $(".profile-checks:not(:icontains(" + val + "))").hide();
    } else {
      return $(".profile-checks").show();
    }
  };

  jQuery(function() {
    $('#profiles input#search').keyup(function() {
      return searchModules($(this).val());
    });
    $('#profiles button.check').click(function() {
      $('.profile-checks input:visible:checkbox').attr('checked', 'checked');
      return false;
    });
    return $('#profiles button.uncheck').click(function() {
...
(function() {
  ...
  window.scrollToSelectedGroup = function() {
    return $('.scan-groups-list').scrollTop(window.userScrolled);
  };

  window.setupScanGroupHooks = function() {
    window.scrollToSelectedGroup();
    return $('.scan-groups-list').scroll(function() {
      return window.userScrolled = $('.scan-groups-list').scrollTop();
    });
  };

  jQuery(function() {
    return window.setupScanGroupHooks();
  });
...
(function() {
  ...
  searchModules = function(val) {
    $("#settings ").show();
    if (val !== '') {
      return $("#settings .check:not(:icontains(" + val + "))").hide();
    } else {
      return $("#settings .check").show();
    }
  };

  jQuery(function() {
    $('#settings input#search').keyup(function() {
      return searchModules($(this).val());
    });
    $('#settings #profile button.check').click(function() {
      $('#settings .check input:visible:checkbox').attr('checked', 'checked');
      return false;
    });
    return $('#settings #profile button.uncheck').click(function() {
