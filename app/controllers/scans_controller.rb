...
@scanpage=params.fetch(:scanpage,0).to_i
@scans = Scan.offset(@scanpage*Elements_per_page).limit(Elements_per_page)
    ...
    def report
        ...
        if format == 'afr'
            ...
            report    = @scan.report.object.to_pdf
            extension = 'pdf'
        else
